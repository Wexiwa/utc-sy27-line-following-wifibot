...
#include "maps_Stream8IOSample.h"
...
MAPS_BEGIN_OUTPUTS_DEFINITION(MAPSStream8IOSample)
	...
	MAPS_OUTPUT("veh_speed",MAPS::Float,NULL,"km/h",1)
...
MAPS_COMPONENT_DEFINITION(MAPSStream8IOSample,"Stream8IOSample","1.0",128,MAPS::Sequential|MAPS::Threaded,
