...
void MAPSmultiplier1::Core() 
{
	...
	//Write the result in the MAPSIOElt object (MAPSIOElt::Integer() returns a C++ reference to the contained integer).
	ioEltOut->Integer() = result;
